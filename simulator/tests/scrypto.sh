...
echo "size1"
ls -la ../examples/everything/target/wasm32-unknown-unknown/release/everything.wasm
ls -la ../examples/everything/target/wasm32-unknown-unknown/release/everything.wasm | cut -d ' ' -f 5
