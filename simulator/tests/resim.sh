...
# Set up environment
$resim reset
temp=`$resim new-account | tee /dev/tty | awk '/Account component ref:|Public key:/ {print $NF}'`
account=`echo $temp | cut -d " " -f1`
account_key=`echo $temp | cut -d " " -f2`
account2=`$resim new-account | tee /dev/tty | awk '/Account component ref:/ {print $NF}'`
...
$resim publish ../examples/core/cross-blueprint-call --package-ref 01bda8686d6c2fa45dce04fac71a09b54efbc8028c23aac74bc00e
