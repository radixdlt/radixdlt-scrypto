...
mod tests {
    ...
    test_from_into_precise_decimal_decimal! {
        ...
        ("57896044618658097711785492504343953926634992332820282019728.792003956564819967", "57896044618658097711785492504343953926634992332820282019728.792003956564819967", 6),
        ("-57896044618658097711785492504343953926634992332820282019728.792003956564819967", "-57896044618658097711785492504343953926634992332820282019728.792003956564819967", 7)
    }
    ...
    test_from_precise_decimal_decimal_overflow! {
        ...
        (PreciseDecimal::from(Decimal::MIN), 4)
    }
