...
impl Describe<ScryptoCustomTypeKind> for Ed25519PublicKey {
    const TYPE_ID: GlobalTypeId =
        GlobalTypeId::WellKnown(well_known_scrypto_custom_types::ED25519_PUBLIC_KEY_TYPE);
...
impl Describe<ScryptoCustomTypeKind> for Ed25519PublicKeyHash {
    const TYPE_ID: GlobalTypeId =
        GlobalTypeId::WellKnown(well_known_scrypto_custom_types::ED25519_PUBLIC_KEY_HASH_TYPE);
