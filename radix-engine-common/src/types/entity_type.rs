...
#[repr(u8)]
#[derive(Clone, Copy, Debug, PartialEq, Eq, Ord, PartialOrd, FromRepr, Sbor)]
pub enum EntityType {
    //=========================================================================
    // Package (start with char p for package)
    //=========================================================================
    /// A global package entity. Gives Bech32 prefix: `p` followed by one of `5`, `4`, `k` or `h`.
    GlobalPackage = 0b00001101, //------------------- 00001 => p, 101xx => 54kh [pkg vanity prefix]

    //=========================================================================
    // System Components (start with char s for system)
    //=========================================================================
    /// The global epoch manager entity. Gives Bech32 prefix: `s` followed by one of `c`, `e`, `6` or `m`.
    ...
    //=========================================================================
    /// A global generic (eg scrypto) component entity. Gives Bech32 prefix: `c` followed by one of `q`, `p`, `z` or `r`.
    GlobalGenericComponent = 0b11000000, //---------- 11000 => c, 000xx => qpzr [cpt vanity prefix] (000 = generic component)

    /// A global non-virtual native account component entity. Gives Bech32 prefix: `c` followed by one of `y`, `9`, `x` or `8`.
    GlobalAccount = 0b11000001, //------------------- 11000 => c, 001xx => y9x8 (001 = account)

    /// A global non-virtual native identity component entity. Gives Bech32 prefix: `c` followed by one of `g`, `f`, `2` or `t`.
    GlobalIdentity = 0b11000010, //------------------ 11000 => c, 010xx => gf2t (010 = identity)

    /// A global native access controller entity. Gives Bech32 prefix: `c` followed by one of `v`, `d`, `w` or `0`.
    ...
    //=========================================================================
    /// A global virtual Secp256k1 account component entity. Gives Bech32 prefix: `6` followed by one of `y`, `9`, `x` or `8`.
    GlobalVirtualSecp256k1Account = 0b11010001, //--- 11010 => 6, 001xx => y9x8 (001 = account)

    /// A global virtual Secp256k1 identity component entity. Gives Bech32 prefix: `6` followed by one of `g`, `f`, `2` or `t`.
    ...
    //=========================================================================
    /// A global virtual Ed25519 account component entity. Gives Bech32 prefix: `2` followed by one of `y`, `9`, `x` or `8`.
    GlobalVirtualEd25519Account = 0b01010001, //----- 01010 => 2, 001xx => y9x8 (001 = account)

    /// A global virtual Ed25519 identity component entity. Gives Bech32 prefix: `2` followed by one of `g`, `f`, `2` or `t`.
    GlobalVirtualEd25519Identity = 0b01010010, //---- 01010 => 2, 010xx => gf2t (010 = identity)

    //=========================================================================
    // Fungible-related (start with letter t for token)
    //=========================================================================
    /// A global fungible resource entity. Gives Bech32 prefix: `t` followed by one of `5`, `4`, `k` or `h`.
    GlobalFungibleResource = 0b01011101, //---------- 01011 => t, 101xx => 54kh [tkn vanity prefix]
    /// An internal fungible vault entity. Gives Bech32 prefix: `t` followed by one of `q`, `p`, `z` or `r`.
    ...
    //=========================================================================
    /// A global non-fungible resource entity. Gives Bech32 prefix: `n` followed by one of `g`, `f`, `2` or `t`.
    GlobalNonFungibleResource = 0b10011010, //------- 10011 => n, 010xx => gf2t [nf  vanity prefix]

    /// An internal non-fungible vault entity. Gives Bech32 prefix: `n` followed by one of `q`, `p`, `z` or `r`.
    ...
    //=========================================================================
    /// An internal generic (eg scrypto) component entity. Gives Bech32 prefix: `l` followed by one of `q`, `p`, `z` or `r`.
    InternalGenericComponent = 0b11111000, //-------- 11111 => l, 000xx => qpzr (000 = generic component)

    /// An internal non-virtual native account component entity. Gives Bech32 prefix: `l` followed by one of `y`, `9`, `x` or `8`.
    ...
    //=========================================================================
    /// An internal key-value store entity. Gives Bech32 prefix: `k` followed by one of `q`, `p`, `z` or `r`.
    ///
    ...
    /// An internal index entity. Gives Bech32 prefix: `k` followed by one of `q`, `p`, `z` or `r`.
    ///
    ...
    /// An internal sorted index entity. Gives Bech32 prefix: `k` followed by one of `q`, `p`, `z` or `r`.
    ///
