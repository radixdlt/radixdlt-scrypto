...
impl NodeId {
    ...
    pub const RANDOM_LENGTH: usize = 29;
    pub const LENGTH: usize = Self::ENTITY_ID_LENGTH + Self::RANDOM_LENGTH;

    pub fn new(entity_byte: u8, random_bytes: &[u8; Self::RANDOM_LENGTH]) -> Self {
