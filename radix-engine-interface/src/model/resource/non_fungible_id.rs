...
pub trait NonAutoGeneratedNonFungibleIdType: NonFungibleIdType {}

pub trait NonFungibleIdType: Into<NonFungibleId> {
    fn id() -> NonFungibleIdTypeId;
}

impl NonAutoGeneratedNonFungibleIdType for u64 {}
...
impl NonAutoGeneratedNonFungibleIdType for String {}
impl From<String> for NonFungibleId {
    fn from(value: String) -> Self {
        Self::String(value)
    }
}
impl NonFungibleIdType for String {
    fn id() -> NonFungibleIdTypeId {
        NonFungibleIdTypeId::String
    }
}

impl NonAutoGeneratedNonFungibleIdType for Vec<u8> {}
impl From<Vec<u8>> for NonFungibleId {
    fn from(value: Vec<u8>) -> Self {
        Self::Bytes(value)
    }
}
impl NonFungibleIdType for Vec<u8> {
    fn id() -> NonFungibleIdTypeId {
