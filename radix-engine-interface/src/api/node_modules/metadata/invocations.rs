...
metadata_type!(String, METADATA_VALUE_STRING_TYPE_ID, String);

metadata_type!(bool, METADATA_VALUE_BOOLEAN_TYPE_ID, Bool);

metadata_type!(u8, METADATA_VALUE_U8_TYPE_ID, U8);

metadata_type!(u32, METADATA_VALUE_U32_TYPE_ID, U32);

metadata_type!(u64, METADATA_VALUE_U64_TYPE_ID, U64);

metadata_type!(i32, METADATA_VALUE_I32_TYPE_ID, I32);

metadata_type!(i64, METADATA_VALUE_I64_TYPE_ID, I64);

impl MetadataVal for Decimal {
    const TYPE_ID: u8 = METADATA_VALUE_DECIMAL_TYPE_ID;
...
impl MetadataVal for Address {
    const TYPE_ID: u8 = METADATA_VALUE_ADDRESS_TYPE_ID;
...
impl MetadataVal for PublicKey {
    const TYPE_ID: u8 = METADATA_VALUE_PUBLIC_KEY_TYPE_ID;
