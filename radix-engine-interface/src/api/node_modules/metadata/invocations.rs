...
pub const METADATA_SETTER_ROLE: &str = "setter";
pub const METADATA_SETTER_UPDATER_ROLE: &str = "setter_updater";
...
pub struct MetadataCreateWithDataInput {
    pub data: BTreeMap<String, MetadataValue>,
}
...
pub const METADATA_FREEZE_IDENT: &str = "freeze";

#[derive(Debug, Clone, Eq, PartialEq, ScryptoSbor, ManifestSbor)]
pub struct MetadataFreezeInput {
    pub key: String,
}

pub type MetadataFreezeOutput = ();
