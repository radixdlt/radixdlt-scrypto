...
pub const COMPONENT_ROYALTY_ADMIN_ROLE: &str = "royalty_admin";
...
pub struct ComponentSetRoyaltyInput {
    pub method: String,
    pub amount: RoyaltyAmount,
}

pub type ComponentSetRoyaltyOutput = ();
...
pub struct ComponentLockRoyaltyInput {
    pub method: String,
}

pub type ComponentLockRoyaltyOutput = ();
