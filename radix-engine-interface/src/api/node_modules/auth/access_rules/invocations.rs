...
pub struct AccessRulesCreateInput {
    ...
    pub inner_blueprint_rules: BTreeMap<String, (Roles, BTreeMap<MethodKey, (MethodPermission, RoleList)>)>,
}
...
pub struct AccessRulesSetMethodPermissionsAndMutabilityInput {
    pub object_key: ObjectKey,
    pub authority_key: RoleKey,
    pub rule: AccessRule,
