...
// TODO: This is updated in the next PR to follow the separate set and lock method pattern
pub const ACCESS_RULES_UPDATE_OWNER_ROLE_IDENT: &str = "update_owner_role";

#[cfg_attr(feature = "radix_engine_fuzzing", derive(Arbitrary))]
#[derive(
    Debug, Clone, Eq, PartialEq, ScryptoSbor, ManifestCategorize, ManifestEncode, ManifestDecode,
)]
pub struct AccessRulesUpdateOwnerRoleInput {
    pub rule: Option<AccessRule>,
    pub freeze: bool,
}

pub type AccessRulesUpdateOwnerRoleOutput = ();
