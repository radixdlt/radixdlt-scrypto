...
pub const ACCESS_RULES_SET_METHOD_PERMISSION_AND_MUTABILITY_IDENT: &str =
    "set_method_permission_and_mutability";

#[derive(
    Debug, Clone, Eq, PartialEq, ScryptoSbor, ManifestCategorize, ManifestEncode, ManifestDecode,
)]
pub struct AccessRulesSetMethodPermissionAndMutabilityInput {
