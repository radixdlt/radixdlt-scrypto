...
pub type RoleAssignmentGetOutput = Option<Rule>;

pub trait ToRoleEntry {
    fn to_role_entry(self) -> Option<Rule>;
}

impl ToRoleEntry for Rule {
    fn to_role_entry(self) -> Option<Rule> {
        Some(self)
    }
}
...
impl ToRoleEntry for Option<Rule> {
    fn to_role_entry(self) -> Option<Rule> {
        self
    }
}

pub type RoleDefinition = Option<Rule>;
