...
macro_rules! access_rule_node {
    // Handle leaves
    ($rule:ident $args:tt) => {{ radix_engine_interface::api::blueprints::resource::AccessRuleNode::ProofRule($rule $args) }};
...
macro_rules! rule {
    (allow_all) => {{
        radix_engine_interface::api::blueprints::resource::AccessRule::AllowAll
    }};
    (deny_all) => {{
        radix_engine_interface::api::blueprints::resource::AccessRule::DenyAll
    }};
    ($($tt:tt)+) => {{
        radix_engine_interface::api::blueprints::resource::AccessRule::Protected($crate::access_rule_node!($($tt)+))
    }};
}
