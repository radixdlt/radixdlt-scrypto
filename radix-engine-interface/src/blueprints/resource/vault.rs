...
impl Describe<ScryptoCustomTypeKind> for Vault {
    const TYPE_ID: DefinitionTypeId =
        DefinitionTypeId::WellKnown(well_known_scrypto_custom_types::OWN_VAULT_TYPE);
...
impl Describe<ScryptoCustomTypeKind> for FungibleVault {
    const TYPE_ID: DefinitionTypeId =
        DefinitionTypeId::WellKnown(well_known_scrypto_custom_types::OWN_FUNGIBLE_VAULT_TYPE);
...
impl Describe<ScryptoCustomTypeKind> for NonFungibleVault {
    const TYPE_ID: DefinitionTypeId =
        DefinitionTypeId::WellKnown(well_known_scrypto_custom_types::OWN_NON_FUNGIBLE_VAULT_TYPE);
