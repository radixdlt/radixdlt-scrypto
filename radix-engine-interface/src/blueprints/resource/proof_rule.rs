...
impl Describe<ScryptoCustomTypeKind> for ResourceOrNonFungible {
    const TYPE_ID: GlobalTypeId =
        GlobalTypeId::WellKnown(well_known_scrypto_custom_types::RESOURCE_OR_NON_FUNGIBLE_TYPE);
...
impl Describe<ScryptoCustomTypeKind> for ProofRule {
    const TYPE_ID: GlobalTypeId =
        GlobalTypeId::WellKnown(well_known_scrypto_custom_types::PROOF_RULE_TYPE);
...
impl Describe<ScryptoCustomTypeKind> for AccessRuleNode {
    const TYPE_ID: GlobalTypeId =
        GlobalTypeId::WellKnown(well_known_scrypto_custom_types::ACCESS_RULE_NODE_TYPE);
...
impl Describe<ScryptoCustomTypeKind> for AccessRule {
    const TYPE_ID: GlobalTypeId =
        GlobalTypeId::WellKnown(well_known_scrypto_custom_types::ACCESS_RULE_TYPE);
