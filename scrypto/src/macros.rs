...
macro_rules! error {
    ($($args: expr),+) => {{
        ::scrypto::runtime::Logger::log(radix_engine_interface::api::blueprints::logger::Level::Error, ::sbor::rust::format!($($args),+));
    }};
}
...
macro_rules! warn {
    ($($args: expr),+) => {{
        ::scrypto::runtime::Logger::log(radix_engine_interface::api::blueprints::logger::Level::Warn, ::sbor::rust::format!($($args),+));
    }};
}
...
macro_rules! info {
    ($($args: expr),+) => {{
        ::scrypto::runtime::Logger::log(radix_engine_interface::api::blueprints::logger::Level::Info, ::sbor::rust::format!($($args),+));
    }};
}
...
macro_rules! debug {
    ($($args: expr),+) => {{
        ::scrypto::runtime::Logger::log(radix_engine_interface::api::blueprints::logger::Level::Debug, ::sbor::rust::format!($($args),+));
    }};
}
...
macro_rules! trace {
    ($($args: expr),+) => {{
        ::scrypto::runtime::Logger::log(radix_engine_interface::api::blueprints::logger::Level::Trace, ::sbor::rust::format!($($args),+));
    }};
}
