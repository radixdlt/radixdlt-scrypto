...
macro_rules! error {
    ($($args: expr),+) => {{
        $crate::runtime::Logger::error(::radix_rust::rust::format!($($args),+));
    }};
}
...
macro_rules! warn {
    ($($args: expr),+) => {{
        $crate::runtime::Logger::warn(::radix_rust::rust::format!($($args),+));
    }};
}
...
macro_rules! info {
    ($($args: expr),+) => {{
        $crate::runtime::Logger::info(::radix_rust::rust::format!($($args),+));
    }};
}
...
macro_rules! debug {
    ($($args: expr),+) => {{
        $crate::runtime::Logger::debug(::radix_rust::rust::format!($($args),+));
    }};
}
...
macro_rules! trace {
    ($($args: expr),+) => {{
        $crate::runtime::Logger::trace(::radix_rust::rust::format!($($args),+));
    }};
}
