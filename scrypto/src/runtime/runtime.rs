...
use radix_engine_interface::blueprints::epoch_manager::{EPOCH_MANAGER_GET_CURRENT_EPOCH_IDENT, EpochManagerGetCurrentEpochInput};
...
impl Runtime {
    ...
    pub fn current_epoch() -> u64 {
        let rtn = ScryptoEnv.call_method(
