...
use crate::core::{FnIdent, MethodIdent, NativeMethodFnIdent};
use crate::core::{Receiver, ResourceManagerMethodFnIdent};
...
impl ResourceManager {
    ...
    native_functions! {
        Receiver::Ref(RENodeId::Global(GlobalAddress::Resource(self.0))), NativeMethodFnIdent::ResourceManager => {
