...
impl<Y: IsNonAutoGeneratedNonFungibleLocalId> NonFungibleResourceBuilder<Y> {
    ...
    ///     .initial_supply([
    ///         (1u64, NFData { name: "NF One".to_owned(), flag: true }),
    ///         (2u64, NFData { name: "NF Two".to_owned(), flag: true }),
    ///     ]);
    /// ```
