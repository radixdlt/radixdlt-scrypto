...
impl ScryptoValueFormatter {
    ...
    pub fn from_custom_value(
        ...
        match ScryptoType::from_id(type_id).unwrap() {
            ScryptoType::U8 => format!("{}su8", U8::try_from(data).unwrap()),
            ScryptoType::U16 => format!("{}su16", U16::try_from(data).unwrap()),
            ScryptoType::U32 => format!("{}su32", U32::try_from(data).unwrap()),
            ScryptoType::U64 => format!("{}su64", U64::try_from(data).unwrap()),
            ScryptoType::U128 => format!("{}su128", U128::try_from(data).unwrap()),
            ScryptoType::U256 => format!("{}su256", U256::try_from(data).unwrap()),
            ScryptoType::U384 => format!("{}su384", U384::try_from(data).unwrap()),
            ScryptoType::U512 => format!("{}su512", U512::try_from(data).unwrap()),
            ScryptoType::I8 => format!("{}si8", I8::try_from(data).unwrap()),
            ScryptoType::I16 => format!("{}si16", I16::try_from(data).unwrap()),
            ScryptoType::I32 => format!("{}si32", I32::try_from(data).unwrap()),
            ScryptoType::I64 => format!("{}si64", I64::try_from(data).unwrap()),
            ScryptoType::I128 => format!("{}si128", I128::try_from(data).unwrap()),
            ScryptoType::I256 => format!("{}si256", I256::try_from(data).unwrap()),
            ScryptoType::I384 => format!("{}si384", I384::try_from(data).unwrap()),
            ScryptoType::I512 => format!("{}si512", I512::try_from(data).unwrap()),
