...
impl<T> RoyaltyRoles<T> {
    pub fn list(self) -> Vec<(&'static str, T)> {
        vec![
            ...
            (COMPONENT_ROYALTY_ADMIN_UPDATER_ROLE, self.royalty_admin_updater),
        ]
    }
}
