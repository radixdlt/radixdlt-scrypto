...
impl ValidatorBlueprint {
        ...
        Y: ClientApi<RuntimeError>,
    {
        ...
        api.field_write_typed(handle, &validator)?;
        ...
        Y: ClientApi<RuntimeError>,
    {
        ...
        let (unstake_bucket, new_stake_amount) = {
            ...
            let manager_handle = api.method_actor_open_field(
            ...
            let config_handle = api.method_actor_open_field(
                OBJECT_HANDLE_OUTER_OBJECT,
        ...
        api.field_write_typed(handle, &validator_substate)?;
        ...
        Y: ClientApi<RuntimeError>,
    {
        let validator_address: ComponentAddress =
            ComponentAddress::new_or_panic(api.method_actor_get_global_address()?.into());
        let new_sorted_key =
        ...
        Y: ClientApi<RuntimeError>,
    {
        ...
        let current_epoch = {
            let mgr_handle = api.method_actor_open_field(
                OBJECT_HANDLE_OUTER_OBJECT,
                ConsensusManagerField::ConsensusManager.into(),
                LockFlags::read_only(),
            )?;
        ...
        Y: ClientApi<RuntimeError>,
    {
        ...
        let consensus_manager_handle = api.method_actor_open_field(
            OBJECT_HANDLE_OUTER_OBJECT,
            ConsensusManagerField::ConsensusManager.into(),
            LockFlags::read_only(),
        )?;
