...
impl AuthVerification {
    fn proof_matches<Y: ClientApi<RuntimeError>>(
    ...
    fn auth_zone_stack_has_amount<Y: ClientApi<RuntimeError>>(
    ...
    fn auth_zone_stack_matches_rule<Y: ClientApi<RuntimeError>>(
        barrier_crossings_allowed: u32,
        resource_rule: &HardResourceOrNonFungible,
        auth_zone: &AuthZoneStackSubstate,
        api: &mut Y,
    ...
    pub fn verify_proof_rule<Y: ClientApi<RuntimeError>>(
        barrier_crossings_allowed: u32,
    ...
    pub fn verify_auth_rule<Y: ClientApi<RuntimeError>>(
        barrier_crossings_allowed: u32,
    ...
    pub fn verify_method_auth<Y: ClientApi<RuntimeError>>(
        barrier_crossings_allowed: u32,
