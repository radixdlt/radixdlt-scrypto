                ...
                for inst in &input.instructions.clone() {
                    let result = match inst {
                            ...
                            .and_then(|new_id| {
                                system_api
                                    .invoke_method(
                                        ...
                                        Function::Native("take_all".to_string()),
                        ...
                        ExecutableInstruction::TakeFromWorktopByAmount {
                            ...
                            .and_then(|new_id| {
                                system_api
                                    .invoke_method(
                                        Receiver::NativeRENodeRef(RENodeId::Worktop),
                                        Function::Native("take_amount".to_string()),
                        ...
                        ExecutableInstruction::TakeFromWorktopByIds {
                            ...
                            .and_then(|new_id| {
                                system_api
                                    .invoke_method(
                                        Receiver::NativeRENodeRef(RENodeId::Worktop),
                                        Function::Native("take_non_fungibles".to_string()),
                        ...
                        ExecutableInstruction::AssertWorktopContains { resource_address } => {
                            system_api.invoke_method(
                                Receiver::NativeRENodeRef(RENodeId::Worktop),
                                Function::Native("assert_contains".to_string()),
                        ...
                        ExecutableInstruction::AssertWorktopContainsByAmount {
                            ...
                            Receiver::NativeRENodeRef(RENodeId::Worktop),
                            Function::Native("assert_contains_amount".to_string()),
                        ...
                        ExecutableInstruction::AssertWorktopContainsByIds {
                            ...
                            Receiver::NativeRENodeRef(RENodeId::Worktop),
                            Function::Native("assert_contains_non_fungibles".to_string()),
                        ...
                        ExecutableInstruction::PushToAuthZone { proof_id } => proof_id_mapping
                            ...
                            .and_then(|real_id| {
                                system_api.invoke_method(
                                    Receiver::AuthZoneRef,
                                    Function::Native("push".to_string()),
                            ...
                            id_allocator
                                ...
                                .and_then(|new_id| {
                                    system_api
                                        .invoke_method(
                                            Receiver::AuthZoneRef,
                                            Function::Native("create_proof".to_string()),
                        ...
                        ExecutableInstruction::CreateProofFromAuthZoneByAmount {
                            ...
                            .and_then(|new_id| {
                                system_api
                                    .invoke_method(
                                        Receiver::AuthZoneRef,
                                        Function::Native("create_proof_by_amount".to_string()),
                        ...
                        ExecutableInstruction::CreateProofFromAuthZoneByIds {
                            ...
                            .and_then(|new_id| {
                                system_api
                                    .invoke_method(
                                        Receiver::AuthZoneRef,
                                        Function::Native("create_proof_by_ids".to_string()),
                                    ...
                                    .map(|real_id| {
                                        system_api
                                            .invoke_method(
                                                ...
                                                Function::Native("clone".to_string()),
                        ...
                        ExecutableInstruction::DropProof { proof_id } => proof_id_mapping
                            ...
                            .map(|real_id| {
                                system_api.invoke_method(
                                    ...
                                    Function::Native("drop".to_string()),
                        ...
                        ExecutableInstruction::CallMethodWithAllResources {
                            ...
                            .invoke_method(
                                Receiver::NativeRENodeRef(RENodeId::Worktop),
                                Function::Native("drain".to_string()),
                            ...
                            .and_then(|result| {
                                ...
                                system_api.invoke_method(
                                    Receiver::Scrypto(RENodeId::Component(*component_address)),
                                    Function::Native(method.to_string()),
