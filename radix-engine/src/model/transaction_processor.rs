                ...
                for inst in &input.instructions.clone() {
                    let result = match inst {
                            ...
                            .and_then(|new_id| {
                                system_api
                                    .invoke_method(
                                        ...
                                        FnIdentifier::Native("take_all".to_string()),
                        ...
                        ExecutableInstruction::TakeFromWorktopByAmount {
                            ...
                            .and_then(|new_id| {
                                system_api
                                    .invoke_method(
                                        Receiver::Ref(RENodeId::Worktop),
                                        FnIdentifier::Native("take_amount".to_string()),
                        ...
                        ExecutableInstruction::TakeFromWorktopByIds {
                            ...
                            .and_then(|new_id| {
                                system_api
                                    .invoke_method(
                                        Receiver::Ref(RENodeId::Worktop),
                                        FnIdentifier::Native("take_non_fungibles".to_string()),
                        ...
                        ExecutableInstruction::ReturnToWorktop { bucket_id } => bucket_id_mapping
                            ...
                            .map(|real_id| {
                                system_api.invoke_method(
                                    Receiver::Ref(RENodeId::Worktop),
                                    FnIdentifier::Native("put".to_string()),
                        ...
                        ExecutableInstruction::AssertWorktopContains { resource_address } => {
                            system_api.invoke_method(
                                Receiver::Ref(RENodeId::Worktop),
                                FnIdentifier::Native("assert_contains".to_string()),
                        ...
                        ExecutableInstruction::AssertWorktopContainsByAmount {
                            ...
                            Receiver::Ref(RENodeId::Worktop),
                            FnIdentifier::Native("assert_contains_amount".to_string()),
                        ...
                        ExecutableInstruction::AssertWorktopContainsByIds {
                            ...
                            Receiver::Ref(RENodeId::Worktop),
                            FnIdentifier::Native("assert_contains_non_fungibles".to_string()),
                            ...
                            .and_then(|new_id| {
                                system_api
                                    .invoke_method(
                                        ...
                                        FnIdentifier::Native("pop".to_string()),
                            ...
                            id_allocator
                                ...
                                .and_then(|new_id| {
                                    system_api
                                        .invoke_method(
                                            Receiver::AuthZoneRef,
                                            FnIdentifier::Native("create_proof".to_string()),
                        ...
                        ExecutableInstruction::CreateProofFromAuthZoneByAmount {
                            ...
                            .and_then(|new_id| {
                                system_api
                                    .invoke_method(
                                        Receiver::AuthZoneRef,
                                        FnIdentifier::Native("create_proof_by_amount".to_string()),
                        ...
                        ExecutableInstruction::CreateProofFromAuthZoneByIds {
                            ...
                            .and_then(|new_id| {
                                system_api
                                    .invoke_method(
                                        Receiver::AuthZoneRef,
                                        FnIdentifier::Native("create_proof_by_ids".to_string()),
                                    ...
                                    .map(|real_id| {
                                        system_api
                                            .invoke_method(
                                                ...
                                                FnIdentifier::Native("clone".to_string()),
                        ...
                        ExecutableInstruction::DropProof { proof_id } => proof_id_mapping
                            ...
                            .map(|real_id| {
                                system_api.invoke_method(
                                    ...
                                    FnIdentifier::Native("drop".to_string()),
                        ...
                        ExecutableInstruction::CallMethodWithAllResources {
                            ...
                            .invoke_method(
                                Receiver::Ref(RENodeId::Worktop),
                                FnIdentifier::Native("drain".to_string()),
