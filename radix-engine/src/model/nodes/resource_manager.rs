...
impl ResourceManager {
        ...
        R: FeeReserve,
    {
        ...
        let resman_handle = system_api.lock_substate(node_id, offset, true, false)?;
        ...
        let rtn = match method {
                ...
                if let Some(non_fungible_store_id) = resource_manager.non_fungible_store_id {
                        ...
                        .expect("Failed to list non-fungible IDs on non-fungible Bucket")
                    {
                        ...
                        let non_fungible_handle =
                            system_api.lock_substate(node_id, offset, true, false)?;
            ...
            ResourceManagerMethod::Mint => {
                ...
                for (id, non_fungible) in non_fungibles {
                    ...
                    let non_fungible_handle = system_api.lock_substate(node_id, offset, true, false)?;
            ...
            ResourceManagerMethod::NonFungibleExists => {
                ...
                let non_fungible_handle = system_api.lock_substate(node_id, offset, false, false)?;
