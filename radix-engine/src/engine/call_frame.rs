        ...
        let (loaded_snode, method_auths) = match &snode_ref {
            ...
            SNodeRef::SystemRef => {
                ...
                value_refs.insert(
                    ValueId::System,
                    REValueInfo {
                        location: REValueLocation::Track(Address::System),
                        visible: true,
                    },
                );
        ...
        self.cost_unit_counter.consume(
            self.fee_table.system_api_cost({
                match value_id {
                    ...
                    ValueId::Bucket(_) => SystemApiCostingEntry::ReturnLocal,
                    ValueId::Proof(_) => SystemApiCostingEntry::ReturnLocal,
                    ValueId::Worktop => SystemApiCostingEntry::ReturnLocal,
                    ValueId::Vault(_) => SystemApiCostingEntry::ReturnGlobal { size: 0 },
                    ValueId::Component(_) => SystemApiCostingEntry::ReturnGlobal { size: 0 },
                    ValueId::KeyValueStore(_) => SystemApiCostingEntry::ReturnGlobal { size: 0 },
