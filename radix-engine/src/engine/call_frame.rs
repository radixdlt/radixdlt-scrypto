    ...
    > {
        let output = match snode {
            ...
            SNodeState::SystemStatic => {
                System::static_main(func_name, call_data, self).map_err(RuntimeError::SystemError)
            }
            ...
            SNodeState::PackageStatic => {
                ValidatedPackage::static_main(func_name, call_data, self)
            ...
            SNodeState::ResourceStatic => {
                ResourceManager::static_main(func_name, call_data, self)
