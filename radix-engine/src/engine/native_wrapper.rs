...
// TODO: Cleanup
pub fn parse_and_invoke_native_fn<Y>(
    native_fn: NativeFn,
    args: Vec<u8>,
    system_api: &mut Y,
        ...
        NativeFn::Method(native_method) => match native_method {
            ...
            NativeMethod::AuthZone(auth_zone_method) => match auth_zone_method {
                ...
                AuthZoneMethod::CreateProofByAmount => {
                    let invocation: AuthZoneCreateProofByAmountInvocation =
                        scrypto_decode(&args)
                            .map_err(|e| RuntimeError::KernelError(KernelError::DecodeError(e)))?;
                    system_api
                        .sys_invoke(invocation)
            ...
            NativeMethod::ResourceManager(resman_method) => match resman_method {
                ...
                ResourceManagerMethod::CreateBucket => {
                    let invocation: ResourceManagerCreateBucketInvocation =
                        scrypto_decode(&args)
                            .map_err(|e| RuntimeError::KernelError(KernelError::DecodeError(e)))?;
                    system_api
                        .sys_invoke(invocation)
                ...
                ResourceManagerMethod::SetResourceAddress => {
                    let invocation: ResourceManagerSetResourceAddressInvocation =
                        scrypto_decode(&args)
                            .map_err(|e| RuntimeError::KernelError(KernelError::DecodeError(e)))?;
                    system_api
                        .sys_invoke(invocation)
            ...
            NativeMethod::EpochManager(epoch_manager_method) => match epoch_manager_method {
                EpochManagerMethod::GetCurrentEpoch => {
                    let invocation: EpochManagerGetCurrentEpochInvocation =
                        scrypto_decode(&args)
                            .map_err(|e| RuntimeError::KernelError(KernelError::DecodeError(e)))?;
                    system_api
                        .sys_invoke(invocation)
            ...
            NativeMethod::Worktop(worktop_method) => match worktop_method {
                ...
                WorktopMethod::AssertContainsAmount => {
                    let invocation: WorktopAssertContainsAmountInvocation =
                        scrypto_decode(&args)
                            .map_err(|e| RuntimeError::KernelError(KernelError::DecodeError(e)))?;
                    system_api
                        .sys_invoke(invocation)
