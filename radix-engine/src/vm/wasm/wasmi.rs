    ...
    pub fn host_funcs_set(
        ...
        let precise_decimal_checked_add = Func::wrap(
            ...
            |caller: Caller<'_, HostState>,
             ...
             num2_len: u32|
             -> Result<u64, Trap> {
                precise_decimal_checked_add(caller, num1_ptr, num1_len, num2_ptr, num2_len)
                    .map_err(Trap::from)
            },
        );
        ...
        let precise_decimal_checked_sub = Func::wrap(
            ...
            |caller: Caller<'_, HostState>,
             ...
             num2_len: u32|
             -> Result<u64, Trap> {
                precise_decimal_checked_sub(caller, num1_ptr, num1_len, num2_ptr, num2_len)
                    .map_err(Trap::from)
            },
        );
        ...
        let precise_decimal_checked_mul = Func::wrap(
            ...
            |caller: Caller<'_, HostState>,
             ...
             num2_len: u32|
             -> Result<u64, Trap> {
                precise_decimal_checked_mul(caller, num1_ptr, num1_len, num2_ptr, num2_len)
                    .map_err(Trap::from)
            },
        );
        ...
        let precise_decimal_checked_div = Func::wrap(
            ...
            |caller: Caller<'_, HostState>,
             ...
             num2_len: u32|
             -> Result<u64, Trap> {
                precise_decimal_checked_div(caller, num1_ptr, num1_len, num2_ptr, num2_len)
                    .map_err(Trap::from)
            },
        );
        ...
        let precise_decimal_checked_neg = Func::wrap(
            store.as_context_mut(),
            |caller: Caller<'_, HostState>, num_ptr: u32, num_len: u32| -> Result<u64, Trap> {
                precise_decimal_checked_neg(caller, num_ptr, num_len).map_err(Trap::from)
            },
        );
        ...
        let precise_decimal_checked_powi = Func::wrap(
            ...
            |caller: Caller<'_, HostState>,
             ...
             exp_len: u32|
             -> Result<u64, Trap> {
                precise_decimal_checked_powi(caller, num_ptr, num_len, exp_ptr, exp_len)
                    .map_err(Trap::from)
            },
        );
        ...
        let precise_decimal_checked_sqrt = Func::wrap(
            store.as_context_mut(),
            |caller: Caller<'_, HostState>, num_ptr: u32, num_len: u32| -> Result<u64, Trap> {
                precise_decimal_checked_sqrt(caller, num_ptr, num_len).map_err(Trap::from)
            },
        );
        ...
        let precise_decimal_checked_cbrt = Func::wrap(
            store.as_context_mut(),
            |caller: Caller<'_, HostState>, num_ptr: u32, num_len: u32| -> Result<u64, Trap> {
                precise_decimal_checked_cbrt(caller, num_ptr, num_len).map_err(Trap::from)
            },
        );
        ...
        let precise_decimal_checked_nth_root = Func::wrap(
            ...
            |caller: Caller<'_, HostState>,
             ...
             n_len: u32|
             -> Result<u64, Trap> {
                precise_decimal_checked_nth_root(caller, num_ptr, num_len, n_ptr, n_len)
                    .map_err(Trap::from)
            },
        );
