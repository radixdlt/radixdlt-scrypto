...
pub struct WasmValidator {
    ...
    pub instrumenter_config: WasmInstrumenterConfig,
}
...
impl Default for WasmValidator {
    fn default() -> Self {
        Self {
            ...
            instrumenter_config: WasmInstrumenterConfig::v1(),
        }
    }
}
...
impl WasmValidator {
    pub fn validate<'a, I: Iterator<Item = &'a BlueprintDefinitionInit>>(
        ...
        WasmModule::init(code)?
            ...
            .inject_instruction_metering(self.instrumenter_config.instruction_cost_rules())?
