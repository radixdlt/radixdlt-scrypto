    ...
    Y: SystemApi<RuntimeError>,
{
    ...
    fn decimal_checked_add(
        ...
        let decimal1 =
            scrypto_decode::<Decimal>(&num1).map_err(|_| WasmRuntimeError::InvalidDecimal)?;
        let decimal2 =
            scrypto_decode::<Decimal>(&num2).map_err(|_| WasmRuntimeError::InvalidDecimal)?;
    ...
    fn decimal_checked_neg(
        ...
        let decimal =
            scrypto_decode::<Decimal>(&num).map_err(|_| WasmRuntimeError::InvalidDecimal)?;
