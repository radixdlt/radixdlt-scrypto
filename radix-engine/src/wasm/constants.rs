...
pub const INSTANTIATE_PACKAGE_FUNCTION_ID: usize = 13;
pub const INSTANTIATE_PACKAGE_FUNCTION_NAME: &str = "instantiate_package";
pub const INSTANTIATE_COMPONENT_FUNCTION_ID: usize = 14;
pub const INSTANTIATE_COMPONENT_FUNCTION_NAME: &str = "instantiate_component";
