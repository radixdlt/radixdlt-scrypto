...
pub trait KernelModule {
    ...
    //======================
    #[inline(always)]
    fn on_init<Y: KernelModuleApi<M, RuntimeError>, M: KernelUpstream>(_api: &mut Y) -> Result<(), RuntimeError> {
        Ok(())
    }

    #[inline(always)]
    fn on_teardown<Y: KernelModuleApi<M, RuntimeError>, M: KernelUpstream>(_api: &mut Y) -> Result<(), RuntimeError> {
        Ok(())
    }
    ...
    #[inline(always)]
    fn after_pop_frame<Y: KernelModuleApi<M, RuntimeError>, M: KernelUpstream>(_api: &mut Y) -> Result<(), RuntimeError> {
        Ok(())
    }
    ...
    #[inline(always)]
    fn after_drop_node<Y: KernelModuleApi<M, RuntimeError>, M: KernelUpstream>(_api: &mut Y) -> Result<(), RuntimeError> {
        Ok(())
    }
