...
impl Actor {
    ...
    pub fn package_address(&self) -> &PackageAddress {
        match &self {
            Actor::Method(_, _, _, package_address, ..) => {
                package_address
            }
            Actor::Function(package_address, ..) => {
                package_address
            }
            Actor::VirtualLazyLoad(package_address, ..) => {
                package_address
            }
        }
    }
    ...
    pub fn blueprint_name(&self) -> &str {
        match &self {
            Actor::Method(_, _, _, _, blueprint_name, ..) => {
                blueprint_name.as_str()
            }
            Actor::Function(_, blueprint_name, ..) => {
                blueprint_name.as_str()
            }
            Actor::VirtualLazyLoad(_, blueprint_name, ..) => {
                blueprint_name.as_str()
            }
        }
    }
    ...
    pub fn method(
        ...
        Self::Method(global_address, method.0, method.1, package_address, blueprint_name, method.2)
    }
