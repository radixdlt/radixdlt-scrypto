    ...
    fn kernel_api_cost_from_cpu_usage(&self, entry: &CostingEntry) -> u32 {
        ((match entry {
            ...
            CostingEntry::LockSubstate {
                ...
                (SysModuleId::AccessRules, Some(EntityType::GlobalVirtualSecp256k1Account)) => 328,
                (SysModuleId::AccessRules, Some(EntityType::GlobalVirtualSecp256k1Identity)) => 321,
                ...
                (SysModuleId::Metadata, Some(EntityType::GlobalVirtualSecp256k1Identity)) => 707,
                ...
                (SysModuleId::Object, Some(EntityType::GlobalVirtualSecp256k1Account)) => 355,
                ...
                (SysModuleId::Royalty, Some(EntityType::GlobalVirtualSecp256k1Account)) => 577,
                (SysModuleId::Royalty, Some(EntityType::GlobalVirtualSecp256k1Identity)) => 290,
                ...
                (SysModuleId::TypeInfo, Some(EntityType::GlobalVirtualSecp256k1Account)) => 318,
                (SysModuleId::TypeInfo, Some(EntityType::GlobalVirtualSecp256k1Identity)) => 323,
