    ...
    fn kernel_api_cost_from_cpu_usage(&self, entry: &CostingEntry) -> u32 {
        ((match entry {
            ...
            CostingEntry::LockSubstate {
                ...
                (SysModuleId::User, Some(EntityType::GlobalAccessController)) => 1562,
                (SysModuleId::User, Some(EntityType::GlobalAccount)) => 356,
                (SysModuleId::User, Some(EntityType::GlobalClock)) => 290,
                (SysModuleId::User, Some(EntityType::GlobalEpochManager)) => 675,
                (SysModuleId::User, Some(EntityType::GlobalFungibleResource)) => 303,
                (SysModuleId::User, Some(EntityType::GlobalGenericComponent)) => 413,
                (SysModuleId::User, Some(EntityType::GlobalNonFungibleResource)) => 355,
                (SysModuleId::User, Some(EntityType::GlobalPackage)) => 290,
                (SysModuleId::User, Some(EntityType::GlobalValidator)) => 1568,
                (SysModuleId::User, Some(EntityType::GlobalVirtualEcdsaAccount)) => 355,
                (SysModuleId::User, Some(EntityType::InternalFungibleVault)) => 577,
                (SysModuleId::User, Some(EntityType::InternalGenericComponent)) => 177,
                (SysModuleId::User, Some(EntityType::InternalNonFungibleVault)) => 290,
