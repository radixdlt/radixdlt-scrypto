    ...
    fn kernel_api_cost_from_cpu_usage(&self, entry: &CostingEntry) -> u32 {
        ((match entry {
            ...
            CostingEntry::LockSubstate {
                ...
                (SysModuleId::ObjectMap, Some(EntityType::InternalGenericComponent)) => 650,
                (SysModuleId::ObjectMap, Some(EntityType::InternalKeyValueStore)) => 671,
                (SysModuleId::ObjectTuple, Some(EntityType::GlobalAccessController)) => 1562,
                (SysModuleId::ObjectTuple, Some(EntityType::GlobalAccount)) => 356,
                (SysModuleId::ObjectTuple, Some(EntityType::GlobalClock)) => 290,
                (SysModuleId::ObjectTuple, Some(EntityType::GlobalEpochManager)) => 675,
                (SysModuleId::ObjectTuple, Some(EntityType::GlobalFungibleResource)) => 303,
                (SysModuleId::ObjectTuple, Some(EntityType::GlobalGenericComponent)) => 413,
                (SysModuleId::ObjectTuple, Some(EntityType::GlobalNonFungibleResource)) => 355,
                (SysModuleId::ObjectTuple, Some(EntityType::GlobalPackage)) => 290,
                (SysModuleId::ObjectTuple, Some(EntityType::GlobalValidator)) => 1568,
                (SysModuleId::ObjectTuple, Some(EntityType::GlobalVirtualEcdsaAccount)) => 355,
                (SysModuleId::ObjectTuple, Some(EntityType::InternalFungibleVault)) => 577,
                (SysModuleId::ObjectTuple, Some(EntityType::InternalGenericComponent)) => 177,
                (SysModuleId::ObjectTuple, Some(EntityType::InternalNonFungibleVault)) => 290,
