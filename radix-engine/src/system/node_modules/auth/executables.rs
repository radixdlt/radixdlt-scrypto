...
use crate::kernel::kernel_api::{ExecutableInvocation, Executor, KernelNodeApi, KernelSubstateApi, LockFlags};
...
impl AccessRulesNativePackage {
    ...
    pub(crate) fn add_access_check<Y>(
        ...
        where
            Y: KernelNodeApi + KernelSubstateApi + ClientApi<RuntimeError>,
    {
        let input: AccessRulesAddAccessCheckInput = scrypto_decode(&scrypto_encode(&input).unwrap())
