...
use crate::kernel::kernel_api::{ExecutableInvocation, Executor, KernelSubstateApi, LockFlags};
...
impl ExecutableInvocation for AccessRulesAddAccessCheckInvocation {
    ...
    fn resolve<D: ClientDerefApi<RuntimeError>>(
        ...
        let resolved_receiver = deref_and_update(self.receiver, NodeModuleId::AccessRules, &mut call_frame_update, deref)?;
        // TODO: Move this into a more static check once node types implemented
        if !matches!(resolved_receiver.receiver.0, RENodeId::Component(..)) {
