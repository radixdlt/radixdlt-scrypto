...
impl AccessRulesChainSubstate {
    ...
    pub fn native_fn_authorization(&self, node_module_id: NodeModuleId, fn_identifier: FnIdentifier) -> Vec<MethodAuthorization> {
        let key = match fn_identifier {
            FnIdentifier::Scrypto(scrypto_fn) => AccessRuleKey::ScryptoMethod(node_module_id, scrypto_fn.ident),
