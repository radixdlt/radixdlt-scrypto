use crate::system::kernel_modules::auth::auth_converter::{convert, convert_contextless};
use crate::system::kernel_modules::auth::method_authorization::MethodAuthorization;
use crate::types::*;
...
impl AccessRulesChainSubstate {
    ...
    pub fn native_fn_authorization(&self, fn_identifier: FnIdentifier) -> Vec<MethodAuthorization> {
        let key = match fn_identifier {
            FnIdentifier::Scrypto(scrypto_fn) => AccessRuleKey::ScryptoMethod(scrypto_fn.ident),
