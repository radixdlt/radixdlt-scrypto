                ...
                auth_config: AuthConfig {
                    ...
                    method_auth: MethodAuthTemplate::Static(
                        method_auth_template!(
                            COMPONENT_ROYALTY_CLAIM_ROYALTIES_IDENT => [COMPONENT_ROYALTY_OWNER_ROLE];
                            COMPONENT_ROYALTY_SET_ROYALTY_IDENT => [COMPONENT_ROYALTY_OWNER_ROLE];
                        ),
                    ),
                },
            },
        ...
        Y: ClientApi<RuntimeError>,
    {
        match export_name {
            ...
            COMPONENT_ROYALTY_SET_ROYALTY_IDENT => {
                ...
                let rtn = ComponentRoyaltyBlueprint::set_royalty(input.method, input.amount, input.freeze, api)?;
