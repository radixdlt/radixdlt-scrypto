        ...
        Y: ClientApi<RuntimeError>,
    {
        match export_name {
            ...
            COMPONENT_ROYALTY_SET_ROYALTY_CONFIG_IDENT => {
                ...
                ComponentRoyaltyBlueprint::set_royalty_config(input, api)
            }
            COMPONENT_ROYALTY_CLAIM_ROYALTY_IDENT => {
                api.consume_cost_units(FIXED_MEDIUM_FEE, ClientCostingReason::RunNative)?;

                ComponentRoyaltyBlueprint::claim_royalty(input, api)
            }
...
impl ComponentRoyaltyBlueprint {
        ...
        Y: ClientApi<RuntimeError>,
    {
        ...
        let handle =
            api.actor_lock_field(OBJECT_HANDLE_SELF, RoyaltyField::RoyaltyConfig.into(), LockFlags::MUTABLE)?;
