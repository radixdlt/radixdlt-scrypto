    ...
    pub fn schema() -> PackageSchema {
        ...
        functions.insert(
            ...
            FunctionSchema {
                ...
                input: aggregator
                    .add_child_type_and_descendents::<ComponentSetRoyaltyInput>(),
                output: aggregator
                    .add_child_type_and_descendents::<ComponentSetRoyaltyOutput>(),
        ...
        functions.insert(
            ...
            FunctionSchema {
                ...
                output: aggregator.add_child_type_and_descendents::<ComponentClaimRoyaltiesOutput>(),
        ...
        Y: ClientApi<RuntimeError>,
    {
        match export_name {
            ...
            COMPONENT_ROYALTY_CLAIM_ROYALTIES_IDENT => {
                ...
                let _input: ComponentSetRoyaltyInput = input.as_typed().map_err(|e| {
                    RuntimeError::SystemUpstreamError(SystemUpstreamError::InputDecodeError(e))
                })?;
                let rtn = ComponentRoyaltyBlueprint::claim_royalty(api)?;
                Ok(IndexedScryptoValue::from_typed(&rtn))
            }
