...
impl RoyaltyNativePackage {
    pub fn schema() -> PackageSchema {
        ...
        let mut substates = Vec::new();
        substates.push(aggregator.add_child_type_and_descendents::<PackageRoyaltyConfigSubstate>());
        substates
            .push(aggregator.add_child_type_and_descendents::<PackageRoyaltyAccumulatorSubstate>());
        ...
        functions.insert(
            ...
            FunctionSchema {
                ...
                export_name: PACKAGE_ROYALTY_SET_ROYALTY_CONFIG_IDENT.to_string(),
            },
        );
        functions.insert(
            ...
            FunctionSchema {
                ...
                export_name: PACKAGE_ROYALTY_CLAIM_ROYALTY_IDENT.to_string(),
            },
        );

        let schema = generate_full_schema(aggregator);
        let package_royalty_schema = BlueprintSchema {
            schema,
            substates,
            functions,
        };
        ...
        PackageSchema {
            blueprints: btreemap!(
                ...
                PACKAGE_ROYALTY_BLUEPRINT.to_string() => package_royalty_schema,
            ),
        }
    }
