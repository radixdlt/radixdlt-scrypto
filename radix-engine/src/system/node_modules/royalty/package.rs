...
impl RoyaltyNativePackage {
    pub fn definition() -> PackageDefinition {
        ...
        let function_access_rules = btreemap!(
            COMPONENT_ROYALTY_BLUEPRINT.to_string() => btreemap!(
...
impl ComponentRoyaltyBlueprint {
        ...
        Y: ClientApi<RuntimeError>,
    {
        ...
        let royalty_vault = substate.royalty_vault;
        let bucket = match royalty_vault {
            Some(mut vault) => vault.take_all(api)?,
