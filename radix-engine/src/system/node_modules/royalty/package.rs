...
use radix_engine_interface::schema::{BlueprintCollectionSchema, BlueprintEventSchemaInit, BlueprintKeyValueStoreSchema, BlueprintStateSchemaInit, FieldSchema, TypeRef};
...
impl RoyaltyNativePackage {
    pub fn definition() -> PackageSetup {
        ...
        let component_royalty_schema = BlueprintStateSchemaInit {
            fields,
            collections,
        };
