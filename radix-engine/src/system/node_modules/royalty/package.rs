...
impl ComponentRoyaltyBlueprint {
        ...
        Y: ClientApi<RuntimeError>,
    {
        ...
        let handle = api.lock_field(RoyaltyOffset::RoyaltyConfig.into(), LockFlags::MUTABLE)?;

        let mut substate: ComponentRoyaltyConfigSubstate = api.sys_read_substate_typed(handle)?;
        ...
        Y: ClientApi<RuntimeError>,
    {
        ...
        let substate: ComponentRoyaltyAccumulatorSubstate = api.sys_read_substate_typed(handle)?;
