...
use radix_engine_interface::api::{
    ClientApi, FieldValue, GenericArgs, KVEntry, OBJECT_HANDLE_SELF,
};
    ...
    pub fn definition() -> PackageDefinition {
        ...
        let blueprints = btreemap!(
            COMPONENT_ROYALTY_BLUEPRINT.to_string() => BlueprintDefinitionInit {
                ...
                dependencies: btreeset!(XRD.into(),),
...
impl ComponentRoyaltyBlueprint {
        ...
        Y: ClientApi<RuntimeError>,
    {
        ...
        let component_id = api.new_object(
            ...
            vec![],
            GenericArgs::default(),
            vec![FieldValue::immutable(&accumulator_substate)],
            kv_entries,
        )?;
        ...
        Y: ClientApi<RuntimeError>,
    {
        ...
        let component_royalty: ComponentRoyaltySubstate =
            api.field_read_typed(accumulator_handle)?;
        ...
        api.field_close(accumulator_handle)?;
        ...
        Y: ClientApi<RuntimeError>,
    {
        ...
        let substate: ComponentRoyaltySubstate = api.field_read_typed(handle)?;
        ...
        Y: KernelApi<SystemConfig<V>>,
    {
        ...
        let component_royalty: FieldSubstate<ComponentRoyaltySubstate> = api
            .kernel_read_substate(accumulator_handle)?
            .as_typed()
            .unwrap();
        if !component_royalty.value.0.enabled {
        ...
        if royalty_charge.is_non_zero() {
            let vault_id = component_royalty.value.0.royalty_vault.0;
