    ...
    pub fn definition() -> PackageDefinition {
        ...
        functions.insert(
            ...
            FunctionSchemaInit {
                receiver: Some(schema::ReceiverInfo::normal_ref_mut()),
                input: TypeRef::Static(
                    aggregator.add_child_type_and_descendents::<ComponentClaimRoyaltyInput>(),
                ),
                output: TypeRef::Static(
                    aggregator.add_child_type_and_descendents::<ComponentClaimRoyaltyOutput>(),
                ),
                export: COMPONENT_ROYALTY_CLAIM_ROYALTY_IDENT.to_string(),
            },
        );
                ...
                auth_config: AuthConfig {
                    ...
                    method_auth: MethodAuthTemplate::Static(
                        method_auth_template!(
                            COMPONENT_ROYALTY_CLAIM_ROYALTY_IDENT => [COMPONENT_ROYALTY_ADMIN_ROLE];
