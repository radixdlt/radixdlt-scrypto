...
use super::AuthZoneStackSubstate;
...
impl AccessRulesNativePackage {
        ...
        Y: KernelNodeApi + KernelSubstateApi + ClientApi<RuntimeError>,
    {
        ...
        let substate: &mut ObjectAccessRulesChainSubstate =
        ...
        Y: KernelNodeApi + KernelSubstateApi + ClientApi<RuntimeError>,
    {
        ...
        // Manual Auth
        {
            ...
            if !auth_zone_stack.check_auth(false, &authorization, api)? {
                return Err(RuntimeError::ApplicationError(
                    ApplicationError::AccessRulesChainError(AccessRulesChainError::Unauthorized(
                        authorization,
                    )),
                ));
            }
        ...
        let access_rules_substate: &mut ObjectAccessRulesChainSubstate =
            api.kernel_get_substate_ref_mut(handle)?;
