...
impl AccessRulesNativePackage {
        ...
        Y: KernelNodeApi + KernelSubstateApi + ClientApi<RuntimeError>,
    {
        match export_name {
            ...
            ACCESS_RULES_SET_METHOD_ACCESS_RULE_AND_MUTABILITY_IDENT => {
                ...
                Self::set_method_access_rule_and_mutability(receiver, input, api)
            }
    ...
    where
        Y: KernelNodeApi + KernelSubstateApi,
    {
        let authorization = if key.node_module_id.eq(&TypedModuleId::AccessRules)
            || key.node_module_id.eq(&TypedModuleId::AccessRules1)
        {
    ...
    pub(crate) fn get_authorization_for_set_method_access_rule<Y>(
        receiver: &NodeId,
        module_id: TypedModuleId,
        input: &IndexedScryptoValue,
        api: &mut Y,
        ...
        Y: KernelNodeApi + KernelSubstateApi + ClientApi<RuntimeError>,
    {
        ...
        let mut substate: MethodAccessRulesSubstate =
            api.kernel_read_substate(handle)?.as_typed().unwrap();
        substate
            .access_rules
            .set_method_access_rule(input.key.clone(), input.rule.clone());
    ...
    pub(crate) fn get_authorization_for_set_method_mutability<Y>(
        receiver: &NodeId,
        module_id: TypedModuleId,
        input: &IndexedScryptoValue,
        api: &mut Y,
        ...
        Y: KernelNodeApi + KernelSubstateApi + ClientApi<RuntimeError>,
    {
        ...
        substate
            .access_rules
            .set_mutability(input.key.clone(), input.mutability.clone());
        api.kernel_write_substate(handle, IndexedScryptoValue::from_typed(&substate))?;
    ...
    pub(crate) fn get_authorization_for_set_method_access_rule_and_mutability<Y>(
        receiver: &NodeId,
        module_id: TypedModuleId,
        input: &IndexedScryptoValue,
        api: &mut Y,
        ...
        Y: KernelNodeApi + KernelSubstateApi + ClientApi<RuntimeError>,
    {
        ...
        let mut substate: MethodAccessRulesSubstate =
            api.kernel_read_substate(handle)?.as_typed().unwrap();
        let access_rules = &mut substate.access_rules;
        ...
        Y: KernelNodeApi + KernelSubstateApi + ClientApi<RuntimeError>,
    {
        ...
        substate
            .access_rules
            .set_group_access_rule(input.name.clone(), input.rule.clone());
        api.kernel_write_substate(handle, IndexedScryptoValue::from_typed(&substate))?;
        ...
        Y: KernelNodeApi + KernelSubstateApi + ClientApi<RuntimeError>,
    {
        ...
        substate
            .access_rules
            .set_group_mutability(input.name.clone(), input.mutability.clone());
        api.kernel_write_substate(handle, IndexedScryptoValue::from_typed(&substate))?;
        ...
        Y: KernelNodeApi + KernelSubstateApi + ClientApi<RuntimeError>,
    {
        ...
        let mut substate: MethodAccessRulesSubstate =
            api.kernel_read_substate(handle)?.as_typed().unwrap();
        substate.access_rules.set_group_access_rule_and_mutability(
            input.name.as_str(),
            input.rule.clone(),
