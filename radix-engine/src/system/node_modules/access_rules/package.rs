...
impl AccessRulesNativePackage {
        ...
        Y: KernelNodeApi + KernelSubstateApi + ClientApi<RuntimeError>,
    {
        ...
        // Manual Auth
        {
            ...
            auth_zone_stack.check_auth(false, authorization, api)?;
        }
        ...
        Y: KernelNodeApi + KernelSubstateApi + ClientApi<RuntimeError>,
    {
        ...
        // Manual Auth
        {
            ...
            let substate_ref = api.kernel_get_substate_ref(handle)?;
            let auth_zone_substate = substate_ref.auth_zone_stack().clone();
            auth_zone_substate.check_auth(false, authorization, api)?;
        }
