use crate::kernel::kernel_api::{KernelModuleApi, KernelNodeApi, KernelSubstateApi, KernelUpstream};
...
impl AccessRulesNativePackage {
    ...
    pub fn authorization<Y: KernelModuleApi<M, RuntimeError>, M: KernelUpstream>(
        node_id: &NodeId,
        ident: &str,
