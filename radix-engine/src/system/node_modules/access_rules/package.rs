...
use radix_engine_interface::api::{ClientApi, ObjectModuleId, OBJECT_HANDLE_SELF, ClientObjectApi};
use radix_engine_interface::api::node_modules::metadata::METADATA_BLUEPRINT;
use radix_engine_interface::api::node_modules::royalty::COMPONENT_ROYALTY_BLUEPRINT;
use radix_engine_interface::blueprints::package::{AuthConfig, BlueprintDefinitionInit, BlueprintType, BlueprintVersionKey, MethodAuthTemplate, PackageDefinition, StaticRoles};
...
impl AccessRulesNativePackage {
    ...
    fn resolve_update_role_method_permission<Y: KernelApi<SystemConfig<V>>, V: SystemCallbackObject>(
        receiver: &NodeId,
        ...
        match auth_template {
            ...
            MethodAuthTemplate::Static(roles) => {
                match roles.roles.get(&input.role_key) {
