...
impl AccessRulesNativePackage {
        ...
        Y: ClientApi<RuntimeError>,
    {
        match export_name {
            ACCESS_RULES_CREATE_IDENT => {
                ...
                let rtn = Self::create(input.method_authorities, input.authority_rules, input.child_blueprint_rules, api)?;
        ...
        Y: ClientApi<RuntimeError>,
    {
        ...
        method_authorities.set_module_method_authority(ObjectModuleId::Metadata, METADATA_GET_IDENT, "public");
        ...
        let access_rules = AccessRulesConfig::create(method_authorities, authority_rules);
        ...
        Y: ClientApi<RuntimeError>,
    {
        ...
        if let Some(rule) = &rule {
            access_rules.set_authority_access_rule(name.clone(), rule.clone());
        }
        if let Some(mutability) = &mutability {
            access_rules.set_authority_mutability(name.clone(), mutability.clone());
        }
