...
impl MethodAccessRulesSubstate {
    pub fn authority_mutability_authorization(&self, object_key: &ObjectKey, name: &str) -> AccessRule {
        match object_key {
...
impl AccessRulesNativePackage {
        ...
        Y: ClientApi<RuntimeError>,
    {
        ...
        access_rules.set_public(MethodKey::new(ObjectModuleId::Metadata, METADATA_GET_IDENT));
