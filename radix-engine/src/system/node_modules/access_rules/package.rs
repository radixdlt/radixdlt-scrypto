...
impl AccessRulesNativePackage {
    pub fn function_access_rules() -> BTreeMap<FnKey, AccessRule> {
        ...
        access_rules.insert(
            FnKey::new(ACCESS_RULES_BLUEPRINT.to_string(), ACCESS_RULES_CREATE_IDENT.to_string()),
            rule!(allow_all),
        );
        access_rules
    }
    ...
    pub(crate) fn create<Y>(
        ...
        where
            Y: KernelNodeApi + KernelSubstateApi + ClientApi<RuntimeError>,
    {
        let input: AccessRulesCreateInput =
        ...
        Ok(IndexedScryptoValue::from_typed(&Own::Component(node_id.into())))
    }
