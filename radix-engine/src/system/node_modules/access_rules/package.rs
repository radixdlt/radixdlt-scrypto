...
use crate::system::node_modules::access_rules::{LockOwnerRoleEvent, SetAndLockOwnerRoleEvent, SetOwnerRoleEvent};
    ...
    pub fn definition() -> PackageDefinition {
        ...
        functions.insert(
            ...
            FunctionSchemaInit {
                ...
                output: TypeRef::Static(
                    aggregator.add_child_type_and_descendents::<AccessRulesLockRoleOutput>(),
                ),
