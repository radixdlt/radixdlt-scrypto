...
pub const OWNER_AUTHORITY: &str = "owner";
...
impl AccessRulesConfig {
    ...
    fn create(
        ...
        if !authority_rules.rules.contains_key(OWNER_AUTHORITY) {
            authority_rules.set_rule(OWNER_AUTHORITY, AccessRule::DenyAll, AccessRule::DenyAll)
        }
        if !authority_rules.rules.contains_key(METADATA_AUTHORITY) {
            authority_rules.set_rule(METADATA_AUTHORITY, rule!(require(OWNER_AUTHORITY)), rule!(require(OWNER_AUTHORITY)));
        }
        if !authority_rules.rules.contains_key(ROYALTY_AUTHORITY) {
            authority_rules.set_rule(ROYALTY_AUTHORITY, rule!(require(OWNER_AUTHORITY)), rule!(require(OWNER_AUTHORITY)));
        }
