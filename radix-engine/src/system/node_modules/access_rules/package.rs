...
use radix_engine_interface::api::{ClientApi, ClientObjectApi, KVEntry, ObjectModuleId, OBJECT_HANDLE_SELF, FieldValue};
...
impl AccessRulesNativePackage {
        ...
        Y: ClientApi<RuntimeError>,
    {
        ...
        let owner_role_field = match owner_role.updater {
            ...
            OwnerRoleUpdater::Owner | OwnerRoleUpdater::Object => FieldValue::new(&owner_role_substate)
        };
