...
impl CycleCheck<String> for AccessRulesConfig {
    fn get_references(
        &self,
        authority: &String,
    ) -> Result<IndexSet<String>, CycleCheckError<String>> {
...
impl AccessRulesConfig {
    ...
    pub fn set_authority_access_rule<E: Into<AccessRule>>(
        ...
        self.rules
            .insert(authority.clone(), access_rule_entry.into());
    ...
    pub fn set_authority_mutability<M: Into<AccessRule>>(
        ...
        self.mutability
            .insert(authority.clone(), access_rule.into());
...
impl AccessRulesNativePackage {
    ...
    where
        Y: ClientApi<RuntimeError>,
    {
        let access_rules = AccessRulesConfig::create(false, method_authorities, authority_rules)
            .map_err(|e| {
        ...
        for (blueprint, (method_authorities, authority_rules)) in child_blueprint_rules {
            let inner_access_rules = AccessRulesConfig::create(
                true,
                method_authorities,
                authority_rules,
            )
