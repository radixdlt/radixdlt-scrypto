        ...
        if !inner_blueprint {
            ...
            // Metadata
            {
                ...
                if !method_permissions.contains_key(&metadata_set) {
                    method_permissions.insert(metadata_set.clone(), MethodPermission::Protected(RoleList::none()));
...

            {
                ...
                if !method_permissions.contains_key(&royalty_set) {
                    ...
                    method_permissions.insert(royalty_set.clone(), MethodPermission::Protected(role_list));
                    method_permission_mutability.insert(
                        royalty_set, RoleList::none(),
                    );
                }
...
impl AccessRulesNativePackage {
    pub fn schema() -> PackageSchema {
        ...
        functions.insert(
            ...
            FunctionSchema {
                ...
                input: aggregator
                    .add_child_type_and_descendents::<AccessRulesSetMethodPermissionsAndMutabilityInput>(),
                output: aggregator
        ...
        functions.insert(
            ...
            FunctionSchema {
                receiver: Some(schema::ReceiverInfo::normal_ref_mut()),
                input: aggregator
                    .add_child_type_and_descendents::<AccessRulesDefineRoleInput>(),
                output: aggregator
                    .add_child_type_and_descendents::<AccessRulesDefineRoleOutput>(),
    ...
    pub fn authorization<Y: KernelSubstateApi<L>, L: Default>(
        ...
        let roles = match ident {
            ACCESS_RULES_SET_AUTHORITY_RULE_AND_MUTABILITY_IDENT => {
                let input: AccessRulesSetMethodPermissionsAndMutabilityInput =
            ...
            ACCESS_RULES_SET_ROLE_MUTABILITY_IDENT => {
                let input: AccessRulesSetRoleMutabilityInput =
                    input.as_typed().map_err(|e| {
                        RuntimeError::SystemUpstreamError(SystemUpstreamError::InputDecodeError(e))
                    })?;
                Self::authority_mutability_authorization(
    ...
    {
        let access_rules =
            NodeAuthorityRules::create(method_permissions, false, role_definitions).map_err(
                |e| {
