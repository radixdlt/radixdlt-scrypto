...
impl NodeAuthorityRules {
    ...
    fn create(
        ...
        if !inner_blueprint {
            ...
            let owner_authority = AuthorityKey::new(OWNER_AUTHORITY);
            ...
            let metadata_authority = AuthorityKey::new(METADATA_AUTHORITY);
            ...
            let royalty_authority = AuthorityKey::new(ROYALTY_AUTHORITY);
