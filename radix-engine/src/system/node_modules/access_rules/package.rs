...
pub struct NodeAuthorityRules {
    ...
    pub protected_methods: BTreeMap<MethodKey, RoleList>,
...
impl NodeAuthorityRules {
    ...
    fn create(
        mut protected_methods: BTreeMap<MethodKey, RoleList>,
        ...
        if !inner_blueprint {
            ...
            if !authority_rules
                .rules
                .contains_key(&RoleKey::new("owner"))
            {
            ...
            {
                // Always public
                protected_methods.remove(&MethodKey::new(
                ...
                if !protected_methods.contains_key(&metadata_set) {
                    protected_methods.insert(metadata_set, RoleList::none());
                }
            }

            {
                ...
                if !protected_methods.contains_key(&royalty_set) {
                    ...
                    protected_methods.insert(royalty_set, role_list);
                }
                ...
                if !protected_methods.contains_key(&royalty_claim) {
                    ...
                    protected_methods.insert(royalty_claim, role_list);
                }
            }
        }
