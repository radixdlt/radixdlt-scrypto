...
impl MetadataNativePackage {
        ...
        Y: ClientApi<RuntimeError>,
    {
        ...
        for (key, value) in data {
            Self::set(RENodeId::Object(object_id), key, value, api)?;
        }
        ...
        Y: KernelNodeApi + KernelSubstateApi + ClientApi<RuntimeError>,
    {
        ...
        let rtn = match substate {
            KeyValueStoreEntrySubstate::Some(.., ScryptoValue::String { value }) => Some(value),
            KeyValueStoreEntrySubstate::None => None,
            _ => panic!("Unexpected stored substate"),
        };
