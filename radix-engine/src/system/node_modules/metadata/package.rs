...
use radix_engine_interface::schema::{BlueprintCollectionSchema, BlueprintKeyValueStoreSchema, BlueprintSchema, ExportSchema, FunctionSchema, TypeRef};
    ...
    pub fn definition() -> PackageSetup {
        ...
        functions.insert(
            ...
            FunctionSchema {
                ...
                export: ExportSchema::normal(METADATA_CREATE_IDENT),
            },
        );
        functions.insert(
            ...
            FunctionSchema {
                ...
                export: ExportSchema::normal(METADATA_CREATE_WITH_DATA_IDENT),
            },
        );
        functions.insert(
            ...
            FunctionSchema {
                ...
                export: ExportSchema::normal(METADATA_SET_IDENT),
            },
        );
        functions.insert(
            ...
            FunctionSchema {
                ...
                export: ExportSchema::normal(METADATA_GET_IDENT),
            },
        );
        functions.insert(
            ...
            FunctionSchema {
                ...
                export: ExportSchema::normal(METADATA_REMOVE_IDENT),
            },
        );
