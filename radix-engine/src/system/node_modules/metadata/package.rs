...
use radix_engine_interface::schema::{BlueprintCollectionSchema, BlueprintKeyValueStoreSchema, BlueprintSchema, FeaturedSchema, FunctionSchema, TypeRef};
    ...
    pub fn definition() -> PackageSetup {
        ...
        functions.insert(
            ...
            FunctionSchema {
                ...
                export: FeaturedSchema::normal(METADATA_CREATE_IDENT),
            },
        );
        functions.insert(
            ...
            FunctionSchema {
                ...
                export: FeaturedSchema::normal(METADATA_CREATE_WITH_DATA_IDENT),
            },
        );
        functions.insert(
            ...
            FunctionSchema {
                ...
                export: FeaturedSchema::normal(METADATA_SET_IDENT),
            },
        );
        functions.insert(
            ...
            FunctionSchema {
                ...
                export: FeaturedSchema::normal(METADATA_GET_IDENT),
            },
        );
        functions.insert(
            ...
            FunctionSchema {
                ...
                export: FeaturedSchema::normal(METADATA_REMOVE_IDENT),
            },
        );
