...
use radix_engine_interface::schema::{BlueprintKeyValueStoreSchema, BlueprintSchema, FunctionSchema, PackageSchema, TypeSchema};
...
impl MetadataNativePackage {
    pub fn schema() -> PackageSchema {
        ...
        key_value_stores.push(BlueprintKeyValueStoreSchema {
            ...
            value: TypeSchema::Blueprint(aggregator.add_child_type_and_descendents::<MetadataEntry>()),
            can_own: false,
        });
