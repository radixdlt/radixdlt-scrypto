...
use radix_engine_interface::api::{ClientApi, CollectionIndex, GenericArgs, KVEntry, OBJECT_HANDLE_SELF};
...
impl MetadataNativePackage {
    ...
    where
        Y: ClientApi<RuntimeError>,
    {
        let node_id = api.new_object(METADATA_BLUEPRINT, vec![], GenericArgs::default(), vec![], btreemap!())?;
