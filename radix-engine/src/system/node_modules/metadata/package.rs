...
use radix_engine_interface::schema::{BlueprintKeyValueStoreSchema, BlueprintSchema, FunctionSchema, KeyValueStoreSchema, PackageSchema};
...
impl MetadataNativePackage {
    pub fn schema() -> PackageSchema {
        ...
        key_value_stores.push(BlueprintKeyValueStoreSchema::Blueprint(KeyValueStoreSchema {
            ...
            value: aggregator.add_child_type_and_descendents::<MetadataEntry>(),
            can_own: false,
        }));
        ...
        Y: ClientApi<RuntimeError>,
    {
        let cur_value: Option<MetadataEntry> =
            api.actor_key_value_entry_remove_typed(&scrypto_encode(&key).unwrap())?;
