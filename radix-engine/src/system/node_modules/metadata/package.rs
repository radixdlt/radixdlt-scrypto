...
use radix_engine_interface::schema::{BlueprintCollectionSchema, BlueprintKeyValueStoreSchema, BlueprintSchema, ExportNameMapping, FunctionSchema, TypeRef};
    ...
    pub fn definition() -> PackageSetup {
        ...
        functions.insert(
            ...
            FunctionSchema {
                ...
                export: ExportNameMapping::normal(METADATA_CREATE_IDENT),
            },
        );
        functions.insert(
            ...
            FunctionSchema {
                ...
                export: ExportNameMapping::normal(METADATA_CREATE_WITH_DATA_IDENT),
            },
        );
        functions.insert(
            ...
            FunctionSchema {
                ...
                export: ExportNameMapping::normal(METADATA_SET_IDENT),
            },
        );
        functions.insert(
            ...
            FunctionSchema {
                ...
                export: ExportNameMapping::normal(METADATA_GET_IDENT),
            },
        );
        functions.insert(
            ...
            FunctionSchema {
                ...
                export: ExportNameMapping::normal(METADATA_REMOVE_IDENT),
            },
        );
        ...
        let blueprints = btreemap!(
            METADATA_BLUEPRINT.to_string() => BlueprintSetup {
