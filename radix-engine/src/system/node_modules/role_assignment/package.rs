...
use radix_engine_interface::api::{
    ClientApi, FieldValue, KVEntry, ObjectModuleId, OBJECT_HANDLE_SELF,
};
...
impl RoleAssignmentNativePackage {
    ...
    >(
        ...
        let blueprint_id = api
            .get_blueprint_object_info(receiver, module)?
            .blueprint_id;
    ...
    where
        Y: ClientApi<RuntimeError>,
    {
        let handle = api.method_actor_open_field(OBJECT_HANDLE_SELF, 0u8, LockFlags::MUTABLE)?;
