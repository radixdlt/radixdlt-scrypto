...
pub enum TypeInfoSubstate {
    Object(ObjectInfo),
    PhantomObject(PhantomObjectInfo),
...
impl TypeInfoSubstate {
    pub fn outer_object(&self) -> Option<GlobalAddress> {
        match self {
            TypeInfoSubstate::Object(x) => x.outer_object.clone(),
            TypeInfoSubstate::PhantomObject(_) => None,
            TypeInfoSubstate::KeyValueStore(_) => None,
        }
    }
}
