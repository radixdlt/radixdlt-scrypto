...
pub fn create_system_bootstrap_transaction(
    ...
    // XRD Token
    {
        ...
        metadata.insert(
            "symbol".to_owned(),
            MetadataEntry::Value(MetadataValue::String(XRD_SYMBOL.to_owned())),
        );
        metadata.insert(
            "name".to_owned(),
            MetadataEntry::Value(MetadataValue::String(XRD_NAME.to_owned())),
        );
        metadata.insert(
            "description".to_owned(),
            MetadataEntry::Value(MetadataValue::String(XRD_DESCRIPTION.to_owned())),
        );
        metadata.insert(
            "url".to_owned(),
            MetadataEntry::Value(MetadataValue::String(XRD_URL.to_owned())),
        );
        metadata.insert(
            "icon_url".to_owned(),
            MetadataEntry::Value(MetadataValue::String(XRD_ICON_URL.to_owned())),
        );
