...
use radix_engine::model::{BucketError, new_extracted_package, ResourceContainerError};
...
fn test_bucket() {
    ...
    let package = new_extracted_package(compile_package!(format!("./tests/{}", "bucket"))).unwrap();
