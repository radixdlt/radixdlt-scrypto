...
| System          | 3        | "Operating System"      | Type Checking<br>Package/Blueprint/Object semantics<br>Application Standardization (e.g. Authorization, Versioning)                                 | [Substate API](../radix-engine-system-interface/src/api/locked_substate_api)<br>[Object API](../radix-engine-system-interface/src/api/object_api.rs)<br>[Blueprint API](../radix-engine-system-interface/src/api/blueprint_api.rs)<br>[Costing API](../radix-engine-system-interface/src/api/costing_api.rs) | [System Callback API](src/system/system_callback_api.rs) | [System](src/system)                                                                                       |
