...
fn check_identical_schemas<T1: Describe<NoCustomTypeKind>, T2: Describe<NoCustomTypeKind>>() {
    let (type_index1, schema1) = generate_full_schema_from_single_type::<T1, NoCustomTypeSchema>();
    let (type_index2, schema2) = generate_full_schema_from_single_type::<T2, NoCustomTypeSchema>();
