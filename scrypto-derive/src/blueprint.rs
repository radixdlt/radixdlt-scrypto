...
pub fn handle_blueprint(input: TokenStream) -> Result<TokenStream> {
    ...
    let output_abi = {
        ...
        quote! {
            #[no_mangle]
            pub extern "C" fn #abi_ident() -> ::scrypto::engine::wasm_api::VecLeak {
            ...
            if let Visibility::Public(_) = &m.vis {
                ...
                let extern_function = {
                    if is_method {
                        quote! {
                            #[no_mangle]
                            pub extern "C" fn #fn_ident(component_id: ::scrypto::engine::wasm_api::Buffer, args: ::scrypto::engine::wasm_api::Buffer) -> ::scrypto::engine::wasm_api::VecLeak {
                        ...
                        quote! {
                            #[no_mangle]
                            pub extern "C" fn #fn_ident(args: ::scrypto::engine::wasm_api::Buffer) -> ::scrypto::engine::wasm_api::VecLeak {
                                use ::sbor::rust::ops::{Deref, DerefMut};
    ...
    fn test_blueprint() {
        ...
        assert_code_eq(
            ...
            quote! {
                ...
                #[no_mangle]
                pub extern "C" fn Test_x(component_id: ::scrypto::engine::wasm_api::Buffer, args: ::scrypto::engine::wasm_api::Buffer) -> ::scrypto::engine::wasm_api::VecLeak {
                    use ::sbor::rust::ops::{Deref, DerefMut};
                ...
                #[no_mangle]
                pub extern "C" fn Test_y(args: ::scrypto::engine::wasm_api::Buffer) -> ::scrypto::engine::wasm_api::VecLeak {
                    use ::sbor::rust::ops::{Deref, DerefMut};
                ...
                #[no_mangle]
                pub extern "C" fn Test_abi() -> ::scrypto::engine::wasm_api::VecLeak {
                    use ::scrypto::abi::{BlueprintAbi, LegacyDescribe, Fn, Type};
                    use ::sbor::rust::borrow::ToOwned;
                    use ::sbor::rust::vec;
                    use ::sbor::rust::vec::Vec;
