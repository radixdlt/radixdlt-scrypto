                ...
                quote! {
                    impl radix_engine_interface::blueprints::resource::NonFungibleData for #ident {
                        fn decode(immutable_data: &[u8], mutable_data: &[u8]) -> Result<Self, ::sbor::DecodeError> {
                            use ::sbor::{value_kind::*, *};
                            let mut decoder_nm = radix_engine_common::data::scrypto::ScryptoDecoder::new(immutable_data, radix_engine_common::data::scrypto::SCRYPTO_SBOR_V1_MAX_DEPTH);
                            decoder_nm.read_and_check_payload_prefix(radix_engine_common::data::scrypto::SCRYPTO_SBOR_V1_PAYLOAD_PREFIX)?;
                            decoder_nm.read_and_check_value_kind(radix_engine_common::data::scrypto::ScryptoValueKind::Tuple)?;
                            decoder_nm.read_and_check_size(#im_n)?;

                            let mut decoder_m = radix_engine_common::data::scrypto::ScryptoDecoder::new(mutable_data, radix_engine_common::data::scrypto::SCRYPTO_SBOR_V1_MAX_DEPTH);
                            decoder_m.read_and_check_payload_prefix(radix_engine_common::data::scrypto::SCRYPTO_SBOR_V1_PAYLOAD_PREFIX)?;
                            decoder_m.read_and_check_value_kind(radix_engine_common::data::scrypto::ScryptoValueKind::Tuple)?;
                        ...
                        fn immutable_data(&self) -> Result<::sbor::rust::vec::Vec<u8>, ::sbor::EncodeError> {
                            ...
                            let mut encoder = radix_engine_common::data::scrypto::ScryptoEncoder::new(&mut bytes, radix_engine_common::data::scrypto::SCRYPTO_SBOR_V1_MAX_DEPTH);
                            encoder.write_payload_prefix(radix_engine_common::data::scrypto::SCRYPTO_SBOR_V1_PAYLOAD_PREFIX)?;
                            encoder.write_value_kind(radix_engine_common::data::scrypto::ScryptoValueKind::Tuple)?;
