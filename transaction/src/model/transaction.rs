...
mod tests {
    ...
    fn construct_sign_and_notarize() {
        ...
        assert_eq!(
            "eab47e66b34f889d945262987af6192c2bca3e3465e8ed7b1e3e312d542d9ca2",
            transaction.signed_intent.hash().to_string()
        );
        assert_eq!(
            "742a9c967411a1de9ab8921114c6f494ddcf174c9b99049347f4e6e869b58c29",
            transaction.hash().to_string()
        );
        assert_eq!("", hex::encode(scrypto_encode(&transaction)));
    }
}
