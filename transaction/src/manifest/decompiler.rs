...
TAKE_FROM_WORKTOP_BY_IDS Array<NonFungibleId>(NonFungibleId(1u64)) ResourceAddress("resource_sim1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqzqu57yag") Bucket("bucket3");
DROP_ALL_PROOFS;
...
PUBLISH_PACKAGE_WITH_OWNER Blob("36dae540b7889956f1f1d8d46ba23e5e44bf5723aef2a8e6b698686c02583618") Blob("15e8699a6d63a96f66f6feeb609549be2688b96b02119f260ae6dfd012d16a5d") NonFungibleAddress("resource_sim1qqgvpz8q7ypeueqcv4qthsv7ezt8h9m3depmqqw7pc4sfmucfx", 1u64);
"#
        );
    }
...
"#
    ...
    fn test_create_fungible_resource_with_initial_supply_with_owner() {
        ...
        assert_eq!(
            canonical_manifest,
            r#"CALL_METHOD ComponentAddress("account_sim1qwskd4q5jdywfw6f7jlwmcyp2xxq48uuwruc003x2kcskxh3na") "lock_fee" Decimal("10");
CREATE_FUNGIBLE_RESOURCE_WITH_OWNER 18u8 Array<Tuple>(Tuple("description", "A very innovative and important resource"), Tuple("name", "MyResource"), Tuple("symbol", "RSRC")) NonFungibleAddress("resource_sim1qqgvpz8q7ypeueqcv4qthsv7ezt8h9m3depmqqw7pc4sfmucfx", 1u64) Some(Decimal("12"));
CALL_METHOD ComponentAddress("account_sim1qwskd4q5jdywfw6f7jlwmcyp2xxq48uuwruc003x2kcskxh3na") "deposit_batch" Expression("ENTIRE_WORKTOP");
"#
        );
    }
...
"#
    ...
    fn test_create_fungible_resource_with_no_initial_supply_with_owner() {
        ...
        assert_eq!(
            canonical_manifest,
            r#"CALL_METHOD ComponentAddress("account_sim1qwskd4q5jdywfw6f7jlwmcyp2xxq48uuwruc003x2kcskxh3na") "lock_fee" Decimal("10");
CREATE_FUNGIBLE_RESOURCE_WITH_OWNER 18u8 Array<Tuple>(Tuple("description", "A very innovative and important resource"), Tuple("name", "MyResource"), Tuple("symbol", "RSRC")) NonFungibleAddress("resource_sim1qqgvpz8q7ypeueqcv4qthsv7ezt8h9m3depmqqw7pc4sfmucfx", 1u64) None;
"#
        );
    }
    ...
    fn test_create_non_fungible_resource_with_initial_supply() {
        ...
        assert_eq!(
            canonical_manifest,
            r#"CALL_METHOD ComponentAddress("account_sim1qwskd4q5jdywfw6f7jlwmcyp2xxq48uuwruc003x2kcskxh3na") "lock_fee" Decimal("10");
CREATE_NON_FUNGIBLE_RESOURCE Enum("Number") Array<Tuple>(Tuple("description", "A very innovative and important resource"), Tuple("name", "MyResource")) Array<Tuple>(Tuple(Enum("Withdraw"), Tuple(Enum("AllowAll"), Enum("DenyAll"))), Tuple(Enum("Deposit"), Tuple(Enum("AllowAll"), Enum("DenyAll")))) Some(Array<Tuple>(Tuple(NonFungibleId(1u64), Tuple(Tuple("Hello World", Decimal("12")), Tuple(12u8, 19u128)))));
CALL_METHOD ComponentAddress("account_sim1qwskd4q5jdywfw6f7jlwmcyp2xxq48uuwruc003x2kcskxh3na") "deposit_batch" Expression("ENTIRE_WORKTOP");
"#
        );
    }
    ...
    fn test_create_non_fungible_resource_with_initial_supply_with_owner() {
        ...
        assert_eq!(
            canonical_manifest,
            r#"CALL_METHOD ComponentAddress("account_sim1qwskd4q5jdywfw6f7jlwmcyp2xxq48uuwruc003x2kcskxh3na") "lock_fee" Decimal("10");
CREATE_NON_FUNGIBLE_RESOURCE_WITH_OWNER Enum("Number") Array<Tuple>(Tuple("description", "A very innovative and important resource"), Tuple("name", "MyResource")) NonFungibleAddress("resource_sim1qqgvpz8q7ypeueqcv4qthsv7ezt8h9m3depmqqw7pc4sfmucfx", 1u64) Some(Array<Tuple>(Tuple(NonFungibleId(1u64), Tuple(Tuple("Hello World", Decimal("12")), Tuple(12u8, 19u128)))));
CALL_METHOD ComponentAddress("account_sim1qwskd4q5jdywfw6f7jlwmcyp2xxq48uuwruc003x2kcskxh3na") "deposit_batch" Expression("ENTIRE_WORKTOP");
"#
        );
    }
    ...
    fn test_create_non_fungible_resource_with_no_initial_supply() {
        ...
        assert_eq!(
            canonical_manifest,
            r#"CALL_METHOD ComponentAddress("account_sim1qwskd4q5jdywfw6f7jlwmcyp2xxq48uuwruc003x2kcskxh3na") "lock_fee" Decimal("10");
CREATE_NON_FUNGIBLE_RESOURCE Enum("Number") Array<Tuple>(Tuple("description", "A very innovative and important resource"), Tuple("name", "MyResource")) Array<Tuple>(Tuple(Enum("Withdraw"), Tuple(Enum("AllowAll"), Enum("DenyAll"))), Tuple(Enum("Deposit"), Tuple(Enum("AllowAll"), Enum("DenyAll")))) None;
"#
        );
    }
    ...
    fn test_create_non_fungible_resource_with_no_initial_supply_with_owner() {
        ...
        assert_eq!(
            canonical_manifest,
            r#"CALL_METHOD ComponentAddress("account_sim1qwskd4q5jdywfw6f7jlwmcyp2xxq48uuwruc003x2kcskxh3na") "lock_fee" Decimal("10");
CREATE_NON_FUNGIBLE_RESOURCE_WITH_OWNER Enum("Number") Array<Tuple>(Tuple("description", "A very innovative and important resource"), Tuple("name", "MyResource")) NonFungibleAddress("resource_sim1qqgvpz8q7ypeueqcv4qthsv7ezt8h9m3depmqqw7pc4sfmucfx", 1u64) None;
"#
        );
    }
...
"#
    ...
    fn test_mint_non_fungible() {
        ...
        assert_eq!(
            ...
            r#"CALL_METHOD ComponentAddress("account_sim1qwskd4q5jdywfw6f7jlwmcyp2xxq48uuwruc003x2kcskxh3na") "lock_fee" Decimal("10");
CALL_METHOD ComponentAddress("account_sim1qwskd4q5jdywfw6f7jlwmcyp2xxq48uuwruc003x2kcskxh3na") "create_proof_by_amount" Decimal("1") ResourceAddress("resource_sim1qp075qmn6389pkq30ppzzsuadd55ry04mjx69v86r4wq0feh02");
MINT_NON_FUNGIBLE ResourceAddress("resource_sim1qqgvpz8q7ypeueqcv4qthsv7ezt8h9m3depmqqw7pc4sfmucfx") Array<Tuple>(Tuple(NonFungibleId(12u64), Tuple(Tuple("Hello World", Decimal("12")), Tuple(12u8, 19u128))));
CALL_METHOD ComponentAddress("account_sim1qwskd4q5jdywfw6f7jlwmcyp2xxq48uuwruc003x2kcskxh3na") "deposit_batch" Expression("ENTIRE_WORKTOP");
"#
        );
    }
