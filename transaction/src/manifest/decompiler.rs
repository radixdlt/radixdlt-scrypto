...
fn format_node_id(node_id: &RENodeId, context: &mut DecompilationContext) -> String {
    match node_id {
        ...
        RENodeId::RoyaltyReserve(id) => format!("RoyaltyReserve({}u32)", id),
    }
}
