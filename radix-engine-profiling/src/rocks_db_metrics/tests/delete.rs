...
fn test_delete_per_size() {
    ...
    const PREPARE_DB_WRITE_REPEATS: usize = 20;
...
println!(" rocksdb_data_output={:?}", rocksdb_data_output);
    ...
    //axis_ranges.3 = lin_intercept * 1.2f32;
    if lin_slope < 0f32 {
        axis_ranges.2 = (lin_slope * MAX_SIZE as f32 + lin_intercept) * 1.2f32;
        axis_ranges.3 = lin_intercept * 1.2f32;
    } else {
        axis_ranges.3 = (lin_slope * MAX_SIZE as f32 + lin_intercept) * 1.2f32;
    }
    ...
    S: SubstateDatabase + CommittableSubstateDatabase,
{
    ...
    drop_highest_and_lowest_value(&substate_db, 2);
