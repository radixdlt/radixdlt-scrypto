...
fn generate_bytes(value: &ast::Value) -> Result<Vec<u8>, GeneratorError> {
    match value {
        ...
        v @ _ => invalid_type!(v, ast::Type::Vec),
    }
}
                ...
                instructions: vec![
                    ...
                    Instruction::PublishPackage {
                        code: vec![
                            ...
                            0x05, 0x72, 0x75, 0x73, 0x74, 0x63, 0x1d, 0x31, 0x2e, 0x35, 0x39, 0x2e,
                            0x30, 0x20, 0x28, 0x39, 0x64, 0x31, 0x62, 0x32, 0x31, 0x30, 0x36, 0x65,
                            0x20, 0x32, 0x30, 0x32, 0x32, 0x2d, 0x30, 0x32, 0x2d, 0x32, 0x33, 0x29
                        ]
                    }
                ]
            }
