    ...
    fn test_instructions() {
        ...
        generate_instruction_ok!(
            ...
            Instruction::CallFunction {
                ...
                call_data: invocation!(new(500u32, HashMap::from([("key", 1u8),])))
            }
        );
        generate_instruction_ok!(
            ...
            Transaction {
                instructions: vec![
                    Instruction::CallMethod {
                        ...
                        .unwrap(),
                        call_data: invocation!(withdraw_by_amount(
                            Decimal::from(5u32),
                    ...
                    Instruction::CallMethod {
                        ...
                        .unwrap(),
                        call_data: invocation!(buy_gumball(scrypto::resource::Bucket(512)))
                    },
                    Instruction::AssertWorktopContainsByAmount {
                    ...
                    Instruction::CallMethod {
                        ...
                        .unwrap(),
                        call_data: invocation!(create_proof_by_amount(
                            Decimal::from(5u32),
                            ResourceAddress::from_str(
                                    "030000000000000000000000000000000000000000000000000004"
                                )
