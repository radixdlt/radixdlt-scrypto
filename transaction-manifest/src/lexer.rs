...
impl Lexer {
    ...
    fn tokenize_identifier(&mut self) -> Result<Token, LexerError> {
        ...
        match id.as_str() {
            ...
            "PackageRef" => Ok(TokenKind::PackageRef),
            "ComponentRef" => Ok(TokenKind::ComponentRef),
            "ResourceDefRef" => Ok(TokenKind::ResourceDefRef),
            ...
            "CREATE_PROOF" => Ok(TokenKind::CreateProof),
