...
fn test_dec_macro() {
    ...
    Decimal::try_from("3138550867693340381917894711603833208052.177722232017256447");
    const X14: Decimal = dec!(3138550867693340381917894711603833208051.177722232017256447);
}
...
fn test_pdec_macro() {
    ...
    const X12: PreciseDecimal = pdec!("57896044618658097711785492504343953926634.992332820282019728792003956564819967");
    assert_eq!(X12, PreciseDecimal::MAX);

    const X13: PreciseDecimal = pdec!("-57896044618658097711785492504343953926634.992332820282019728792003956564819968");
