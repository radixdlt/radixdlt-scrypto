...
fn creating_a_pool_with_non_fungible_resources_fails() {
    ...
    let manifest = ManifestBuilder::new()
        .call_function(
            ...
            to_manifest_value(&MultiResourcePoolInstantiateManifestInput {
        ...
        let manifest = ManifestBuilder::new()
            ...
            .take_all_from_worktop(self.pool_unit_resource_address, |builder, bucket| {
                builder.call_method(
                    ...
                    to_manifest_value(&MultiResourcePoolRedeemManifestInput { bucket }),
                )
            })
            .try_deposit_batch_or_abort(self.account_component_address)
            .build();
        ...
        let manifest = ManifestBuilder::new()
            ...
            .take_all_from_worktop(resource_address, |builder, bucket| {
                builder.call_method(
                    ...
                    to_manifest_value(&MultiResourcePoolProtectedDepositManifestInput { bucket }),
                )
            })
            .build();
        self.execute_manifest(manifest, sign)
    ...
    fn protected_withdraw<D: Into<Decimal>>(
        ...
        let manifest = ManifestBuilder::new()
            .call_method(
                ...
                to_manifest_value(&MultiResourcePoolProtectedWithdrawManifestInput {
                    resource_address,
                    amount: amount.into(),
                }),
            )
