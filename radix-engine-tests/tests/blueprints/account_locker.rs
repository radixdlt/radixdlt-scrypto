            ...
            ManifestBuilder::new()
                ...
                .call_function(
                    ...
                    AccountLockerInstantiateManifestInput {
                        ...
                        storer_role: rule!(require(storer_badge)).into(),
                        storer_updater_role: rule!(require(storer_badge)).into(),
                        recoverer_role: rule!(require(recoverer_badge)).into(),
                        recoverer_updater_role: rule!(require(recoverer_badge)).into(),
