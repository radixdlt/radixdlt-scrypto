...
mod vault_test {
    ...
    impl VaultTest {
        ...
        pub fn new_vault_into_map() -> Global<VaultTestComponent> {
        ...
        pub fn invalid_double_ownership_of_vault() -> Global<VaultTestComponent> {
            let bucket = Self::new_fungible();
        ...
        pub fn new_vault_into_map_then_get() -> Global<VaultTestComponent> {
            let bucket = Self::new_fungible();
            let vault = Vault::new(bucket.resource_address());
        ...
        pub fn new_vault_into_vector() -> Global<VaultTestComponent> {
            let bucket = Self::new_fungible();
            let vault = Vault::with_bucket(bucket);
            let bucket = Self::new_fungible();
            let vaults = KeyValueStore::new();
        ...
        pub fn new_fungible_vault_with_take() -> Global<VaultTestComponent> {
            let bucket = Self::new_fungible();
