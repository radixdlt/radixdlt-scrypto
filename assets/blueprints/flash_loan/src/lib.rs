...
mod basic_flash_loan {
    ...
    impl BasicFlashLoan {
        ...
        pub fn instantiate_default(
            ...
            let transient_resource_manager = ResourceBuilder::new_ruid_non_fungible_v2::<BasicFlashLoan, LoanDue>(OwnerRole::Fixed(rule!(require(auth_token.resource_address()))))
                .metadata(metadata! {
                    init {
