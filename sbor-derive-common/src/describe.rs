    ...
    let output = match data {
        Data::Struct(s) => {
            ...
            if !get_sbor_bool_value(&attrs, "transparent_name")? {
                ...
                type_id = quote! {
                    ::sbor::DefinitionTypeId::novel_with_code(
                        stringify!(#ident),
                        &[#type_id],
                        &#code_hash
                    )
            ...
            quote! {
                impl #impl_generics ::sbor::Describe <#custom_type_kind_generic> for #ident #ty_generics #where_clause {
                    const TYPE_ID: ::sbor::DefinitionTypeId = #type_id;

                    fn type_data() -> ::sbor::TypeData<#custom_type_kind_generic, ::sbor::DefinitionTypeId> {
                        #type_data_content
                    }
    ...
    let output = match data {
        Data::Struct(s) => match &s.fields {
            syn::Fields::Named(FieldsNamed { .. }) => {
                ...
                quote! {
                    impl #impl_generics ::sbor::Describe <#custom_type_kind_generic> for #ident #ty_generics #where_clause {
                        const TYPE_ID: ::sbor::DefinitionTypeId = ::sbor::DefinitionTypeId::novel_with_code(
                            stringify!(#ident),
...
mod tests {
    ...
    fn test_named_field_struct_schema() {
        ...
        assert_code_eq(
            output,
            quote! {
                impl <C: ::sbor::CustomTypeKind<::sbor::DefinitionTypeId> > ::sbor::Describe<C> for Test {
                    const TYPE_ID: ::sbor::DefinitionTypeId = ::sbor::DefinitionTypeId::novel_with_code(
                        stringify!(Test),
                        &[],
                        &#code_hash
                    ...
                    fn type_data() -> ::sbor::TypeData <C, ::sbor::DefinitionTypeId> {
                        ::sbor::TypeData::struct_with_named_fields(
                            stringify!(Test),
                            ::sbor::rust::vec![
    ...
    fn test_named_field_struct_schema_custom() {
        ...
        let output = handle_describe(
            input,
            Some("radix_engine_interface::data::ScryptoCustomTypeKind<::sbor::DefinitionTypeId>"),
        )
        .unwrap();
        ...
        assert_code_eq(
            output,
            quote! {
                impl ::sbor::Describe<radix_engine_interface::data::ScryptoCustomTypeKind<::sbor::DefinitionTypeId> >
                    for Test
                {
                    const TYPE_ID: ::sbor::DefinitionTypeId = ::sbor::DefinitionTypeId::novel_with_code(
                        stringify!(Test),
                    ...
                    fn type_data() ->
                        ::sbor::TypeData<
                            radix_engine_interface::data::ScryptoCustomTypeKind<::sbor::DefinitionTypeId>,
                            ::sbor::DefinitionTypeId> {
                        ::sbor::TypeData::struct_with_named_fields(
                            stringify!(Test),
                            ::sbor::rust::vec![
                                (
    ...
    fn test_complex_enum_schema() {
        ...
        assert_code_eq(
            output,
            quote! {
                impl <T: SomeTrait, T2, C: ::sbor::CustomTypeKind<::sbor::DefinitionTypeId> > ::sbor::Describe<C> for Test<T, T2>
                where
                    T: ::sbor::Describe<C>,
                    T2: ::sbor::Describe<C>
                {
