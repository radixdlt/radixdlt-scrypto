...
mod tests {
    ...
    fn test_named_field_struct_schema_custom() {
        ...
        let output = handle_describe(
            input,
            Some("radix_engine_system_interface::data::ScryptoCustomTypeKind<::sbor::RustTypeId>"),
        )
        .unwrap();
        ...
        assert_code_eq(
            output,
            quote! {
                impl ::sbor::Describe<radix_engine_system_interface::data::ScryptoCustomTypeKind<::sbor::RustTypeId> >
                    for Test
                {
                    const TYPE_ID: ::sbor::RustTypeId = ::sbor::RustTypeId::novel_with_code(
                        "Test",
                    ...
                    fn type_data() ->
                        ::sbor::TypeData<
                            radix_engine_system_interface::data::ScryptoCustomTypeKind<::sbor::RustTypeId>,
                            ::sbor::RustTypeId> {
                        ::sbor::TypeData::struct_with_named_fields(
                            "Test",
                            ::sbor::rust::vec![
